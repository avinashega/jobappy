...
function sendHiMessage(recipientId) {
    ...
    sendTextMessage(recipientId, 'Let\'s take the PHQ9 test');
    sendTextMessage(recipientId, 'Over the last two weeks, how often have you been bothered by any of the following problems?');
